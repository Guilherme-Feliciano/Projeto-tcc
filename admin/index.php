    ...
    <nav class="navbar navbar-expand-md navbar-dark bg-primary fixed-top">
      ...
      <div class="collapse navbar-collapse" id="navbarsExampleDefault">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="index.php?pg=lista-anuncios">Produtos</a>
          </li>
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdown01">
              ...
              <a class="dropdown-item" href="index.php?pg=apresentacao-produtos">Aprentacao dos produtos</a>
              <a class="dropdown-item" href="index.php?pg=horario-atendimento">Horario de atendimento</a>
          </li>
